...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError("Bu email yoki username allaqachon mavjud");
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-950">
      <div className="bg-gray-900 p-8 rounded-3xl shadow-2xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 rounded-2xl text-lg font-semibold transition"
          >
            Ro‘yxatdan o‘tish
          </button>
        </form>
